...
# --- Streamlit UI ---
st.set_page_config(page_title="Domain Specific Chatbot - PDF RAG", page_icon="🤖")
st.title("🤖 AI-Powered Q&A Chatbot")
st.markdown("Ask questions about anything based on uploaded PDFs.")
...
# --- Chat Interface ---
query = st.text_input("💬 Ask any question from the pdfs:")
